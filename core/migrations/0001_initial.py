# Generated by Django 6.0.1 on 2026-02-24 16:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.CharField(default=core.models.User._generate_user_id, editable=False, max_length=32, primary_key=True, serialize=False)),
                ...
                ('user_type', models.CharField(choices=[('PRO', 'Stakeholder (Web)'), ('CUSTOMER', 'Customer (Mobile)')], default='CUSTOMER', max_length=16)),
                ...
                ('groups', models.ManyToManyField(blank=True, db_table='users_groups', related_name='custom_users', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, db_table='users_user_permissions', related_name='custom_users', to='auth.permission')),
            ],
            options={
                'db_table': 'users',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('billing', 'Billing'), ('technical', 'Technical'), ('service', 'Service'), ('support', 'Support')], default='support', max_length=32)),
